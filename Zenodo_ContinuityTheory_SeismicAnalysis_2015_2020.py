...
# Earthquake Memory and Volatility Analysis (2015–2020, California Region)
...
# 2. Load Data
# The dataset contains seismic events in California (magnitude ≥4.5) from 2015 to 2020.
df = pd.read_csv('2015-2020_ds.csv')
...
plt.title('Inter-Event Times (2015–2020) vs. Poisson Model')
plt.xlabel('Hours Between Earthquakes')
plt.ylabel('Density')
plt.legend()
plt.savefig('plot_2015_2020_histogram.png')
plt.close()
...
plt.title('Magnitude Over Time (2015–2020)')
plt.xlabel('Time')
plt.ylabel('Magnitude')
plt.grid(True)
plt.savefig('plot_2015_2020_magnitude.png')
plt.close()
...
plt.title('ACF of Inter-Event Times (2015–2020)')
plt.savefig('plot_2015_2020_acf.png')
plt.close()
